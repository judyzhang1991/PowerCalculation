...
variance_test <- function(var1, var2, n1, n2, alpha, test){
  ...
  # Large variance should be the numerator
...
Given: sample variances $s_1^2, s_2^2$, power $\lambda$, significance level $\alpha$, population variances $\sigma_1^2, \sigma_2^2$, population means $\mu_1, \mu_2$, test (1 = lower one-sided test; 2 = upper one-sided test; 3 = two-sided test).

```{r}

cal_sample_size <- function(var1, var2, lambda, alpha, var_p1, var_p2, mu1, mu2, test){
