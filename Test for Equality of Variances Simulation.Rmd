...
n <- 10000
null_ratio <- data.frame(rf(n, nX-1, nY-1, ncp))
alt_ratio <- data.frame(rf(n, nX-1, nY-1, ncp))



ggplot(data = X_dat, mapping = aes(X_sample_sds)) + 
  geom_density(color = "red") + 
  geom_density(data = Y_dat, mapping = aes(Y_sample_sds), color = "blue") +
  geom_vline(xintercept = null_ratio, color = "red") + 
  geom_vline(xintercept = true_ratio, color = "blue")
