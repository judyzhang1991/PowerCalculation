...
cal_power_var(var1_popl, var0_popl, var1, var0, n1, n0, 0.05)
...
for(i in 1:length(var1popls)){
  ...
  trt <- rnorm(n1s[i], mean = mu1, sd = sqrt(var1popls[i]))
  var1s[i] <- (sd(trt))^2
  ctrl <- rnorm(n0s[i], mean = mu0, sd = sqrt(var0popls[i]))
  var0s[i] <- (sd(ctrl))^2
...
result_table <- simulate_power_var(var1popls, var0popls, var1s, var0s, n1s, n0s, alphas)
...
for(i in 1:length(var1popls)){
  ...
  trt <- rnorm(ns[i], mean = mu1, sd = sqrt(var1popls[i]))
  
  var1s[i] <- (sd(trt))^2
  
  ctrl <- rnorm(ns[i], mean = mu0, sd = sqrt(var0popls[i]))
...
result_table_var <- simulate_power_var(var1popls, var0popls, var1s, var0s, ns, ns, alphas)
...
result_table_phi <- simulate_power_var(var1popls, var0popls, var1s, var0s, n1s, n0s, alphas)
...
result_table_size <- simulate_power_var(var1popls, var0popls, var1s, var0s, n1s, n0s, alphas)
...
result_table_phi95 <- simulate_power_var(var1popls, var0popls, var1s, var0s, n1s, n0s, alphas)
...
result_table_phi90 <- simulate_power_var(var1popls, var0popls, var1s, var0s, n1s, n0s, alphas)
...
result_table_phi70 <- simulate_power_var(var1popls, var0popls, var1s, var0s, n1s, n0s, alphas)
...
result_table_phi50 <- simulate_power_var(var1popls, var0popls, var1s, var0s, n1s, n0s, alphas)
