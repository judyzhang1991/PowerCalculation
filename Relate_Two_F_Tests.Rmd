...
meanTest_power50_80_sampleSizes <- tibble(Power = powers_result, Effect_Size = rep(deltas, length(powers)), Sample_Size_per_Group = unlist(ns_mean))




meanTest_power50_80_sampleSizes
