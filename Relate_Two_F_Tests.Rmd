...
for(i in 1:length(ns_mean_80)){
  ...
  phi70_mean80[i] <- cal_effectSize_var(ns_mean_80[i], ns_mean_80[i], power, alpha)
...
for(i in 1:length(ns_mean_80)){
  ...
  phi60_mean80[i] <- cal_effectSize_var(ns_mean_80[i], ns_mean_80[i], power, alpha)
...
for(i in 1:length(ns_mean_80)){
  ...
  phi50_mean80[i] <- cal_effectSize_var(ns_mean_80[i], ns_mean_80[i], power, alpha)
