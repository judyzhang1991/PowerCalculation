...
for(i in 1:length(ns_mean_60)){
  ...
  phi_var_60[i] <- cal_effectSize_var(ns_mean_60[i], ns_mean_60[i], power, alpha)
...
for(i in 1:length(ns_mean_50)){
  ...
  phi_var_50[i] <- cal_effectSize_var(ns_mean_50[i], ns_mean_50[i], power, alpha)
...
# Visualization II: Phi v.s. Sample Size v.s. Power
