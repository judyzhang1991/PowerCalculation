...
ggplot(phi_delta_dat, aes(x = delta, y = phi, group = as.factor(power))) + 
  ...
  ggtitle(label = "Effect Sizes Required for Different Power Levels", subtitle = "F Test for Equality of Population Means and F Test for Equality of Population Variances")
